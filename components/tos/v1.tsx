export function TermOfServiceV1() {
    return (
        <>
            <h1>Term of Service</h1>
            <p>
                Please read these terms of service (&quot;terms&quot;, &quot;terms of service&quot;) carefully before using POSH App and License Server(the &quot;service&quot;) operated by <a target="_blank" rel="noopener" href="https://github.com/iwate">@iwate</a>, Tokyo - Japan (&quot;us&quot;, &#39;we&quot;, &quot;our&quot;).
            </p>
            ...
            <p>
                Before you continue using our website we advise you to read our <a target="_blank" rel="noopener" href="/privacy">privacy policy</a> regarding our user data collection. It will help you better understand our practices.
            </p>
            <h2 id="copyright">Copyright</h2>
            <p>
                Content published on this service (digital downloads, images, texts, graphics, logos) is the property of <a target="_blank" rel="noopener" href="https://github.com/iwate">@iwate</a> and/or its content creators and protected by Japan copyright laws. The entire compilation of the content found on this website is the exclusive property of <a target="_blank" rel="noopener" href="https://github.com/iwate">@iwate</a>, with copyright authorship for this compilation by <a target="_blank" rel="noopener" href="https://github.com/iwate">@iwate</a>.
            </p>
            <h2 id="communications">Communications</h2>
            <p>
                The entire communication with us is electronic. Every time you send us an email or visit our service, you are going to be communicating with us. You hereby consent to receive communications from us. If you subscribe to the news on our service, you are going to receive regular emails from us. We will continue to communicate with you by posting news and notices on our service and by sending you emails. You also agree that all notices, disclosures, agreements and other communications we provide to you electronically meet the legal requirements that such communications be in writing.
            </p>
            <h2 id="applicable-law">Applicable Law</h2>
            <p>
                By visiting this website, you agree that the laws of the Japan, without regard to principles of conflict laws, will govern these terms of service, or any dispute of any sort that might come between us and you, or its business partners and associates.
            </p>
            ...
            <p>
                We reserve all rights to terminate accounts and remove content in their sole discretion.
            </p>
