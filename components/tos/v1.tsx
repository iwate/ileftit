  ...
  return (
    <>
      ...
      <p>
        ...
        an email or visit our service, you are going to be communicating with
        us. You hereby consent to receive communications from us. If you
        subscribe to the news on our service, you are going to receive regular
        emails from us. We will continue to communicate with you by posting news
        and notices on our service and by sending you emails. You also agree
      ...
      <p>
        By visiting this website, you agree that the laws of the Japan, without
        regard to principles of conflict laws, will govern these terms of
        service, or any dispute of any sort that might come between us and you,
      ...
      <p>
        We reserve all rights to terminate accounts and remove content in their
        sole discretion.
      </p>
      ...
      <p>You must not crack the Service.</p>
      <p>
      ...
      <p>
        ...
        retribution) of any Service customer will result in immediate account
        termination.
      </p>
      <p>
        ...
        course, we&#39;ll reach out to the account owner before taking any
        action except in rare cases where the level of use may negatively impact
        the performance of the Service for other customers.
      </p>
      <p>
        We do not warrant that (i) the service will meet your specific
      ...
      <p>
        ...
        you and us and govern your use of the Service, superceding any prior
        agreements between you and us (including, but not limited to, any prior
