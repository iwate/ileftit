export function PrivacyV1() {
    return (
        <>
            ...
            <p>
                'I left it' is owned by <a target="_blank" rel="noopener" href="https://github.com/iwate">@iwate</a>, based in Tokyo - Japan. 
                It referred to as &quot;I&quot;, &quot;Me&quot;, &quot;Our&quot; or &quot;We&quot;. 
                As a customer of this service you&#39;re a &quot;User&quot; or &quot;You&quot; according to this policy. 
                The applications or any services offered by us will be referred to as &quot;I left it&quot;, &quot;App&quot; or &quot;Website&quot;.</p>
            <h2 id="how-does-app-collect-data-about-me">
                How does 'I left it' collect data about me?
            </h2>
            <p>'I left it' collects data about you:</p>
            <ul>
                <li>when you browse the websites, ileftit.com or ileftit.b2clogin.com</li>
                <li>when you create an account for 'I left it' or update your account</li>
            ...
            <p><b>'I left it' collects email address.</b></p>
            <p>When you sign up 'I left it', your email address is stored to <a target="_blank" rel="noopener" href="https://azure.microsoft.com/services/active-directory-b2c/">Azure Active Directory B2C</a></p>
            ...
            <p><b>'I left it' collects IP address.</b></p>
            <p>When you create, replace, delete and try authorizing, your IP address is stored to our log storage.</p>
            ...
            <p>
                All ata about website use on servers in the United States of America. 
            ...
            <h2 id="how-can-i-erase-data-about-me">
                How can I erase data about me?
            </h2>
            <p>
                If you wish to delete your data, email ileftit@iwate.me 
                and let us know which user needs to be erased.
            </p>
            <p>
                We complete the deletion of the data within 30 days.
            </p>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>End of browser session</td>
                        <td>Used to route requests to the appropriate production instance.</td>
                    </tr>
                    <tr>
                        <td>x-ms-cpim-trans</td>
                        <td>End of browser session</td>
                        <td>Used for tracking the transactions (number of authentication requests to Azure AD B2C) and the current transaction.</td>
                    </tr>
                    <tr>
                        <td>x-ms-cpim-sso:{'{id}'}</td>
                        <td>End of browser session</td>
                        <td>Used for maintaining the SSO session. This cookie is set as persistent, when Keep Me Signed In is enabled.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>x-ms-cpim-rp</td>
                        <td>End of browser session</td>
                        <td>Used for storing membership data for the resource provider tenant.</td>
                    </tr>
                    <tr>
                        <td>x-ms-cpim-rc</td>
                        <td>End of browser session</td>
