    ...
    <main>
      ...
      <section className="form-vertical">
        ...
        <dl>
          <dt></dt>
          <dd>
            <button type="button" className="btn" onClick={copy}>{copyText}</button>
          </dd>
        </dl>}
        <dl>
          <dt></dt>
      ...
      <form className="form-vertical" onSubmit={handleSubmit(onSubmit)}>
        ...
        <dl>
          <dt></dt>
          <dd>
            <textarea rows={15} {...register("body", {required: true, maxLength: 10000})}></textarea>
        ...
        <dl>
          <dt></dt>
          <dd>
            <Button type="submit" loading={loading==='create'} disabled={loading}>{t.ActionCreate}</Button>
          </dd>
        </dl>
        <dl>
          <dt></dt>
